...
@export var fade_distance: float = 1.3
@export var fade_offset: float = 0.4
@export var fade_cooldown: float = 0.5

@onready var _player: Player = get_owner().player

var _mat: ShaderMaterial
var _player_transparent: bool = false
var _dist: float
